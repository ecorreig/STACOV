...
fmla = as.formula("Estatines ~ Tabac + HTA + Hiperlipemia + Diabetes + Obesitat +
                  Ant.CI + Ant.Ictus + Ant.MVP + Ant.MPOC.Asma + Ant.MHepC + Ant.MRC")
```

```{r}
m.full = matchit(formula = fmla , data = df, method = "genetic", pop.size = 1200)
